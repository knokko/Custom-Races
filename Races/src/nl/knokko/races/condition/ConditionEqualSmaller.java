...
public class ConditionEqualSmaller extends Condition {
	
	private final Function f1;
	private final Function f2;

	public ConditionEqualSmaller(Function function1, Function function2) {
		this.f1 = function1;
		this.f2 = function2;
	}

	public ConditionEqualSmaller(BitBuffer bits) {
		super(bits);
	...
	public boolean value(RaceStatsConditions params) {
		return f1.value(params) <= f2.value(null);
	}
